...
public class GetFlickrJsonData extends GetRawData
{
    ...
    public void execute()
    {
        ...
        Log.v(LOG_TAG, "BUILT_URI = " +  mDestinationUri.toString());
//        downloadJsonData.execute(mDestinationUri.toString());
    }

    public boolean createAndUpdateUri(String searchCriteria, boolean matchAll)
    {
        final String FLICKR_API_BASE_URL = "http://api.flickr.com/services/feeds/photos_public.gne";
    ...
    public void processResult()
    {
        ...
        {
            Log.e(LOG_TAG, "Error downloading raw datafile");
            return;
        }
